...
> The three reference building blocks of fast-check — arbitraries, properties and runners — and how they fit together into a single test.
...
4. **Plugins** describe how to extend runners to make them even more tailored to your needs.
