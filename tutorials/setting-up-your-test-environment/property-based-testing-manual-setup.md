...
> Set up fast-check with any JavaScript or TypeScript test runner. Learn the runner-agnostic patterns for writing synchronous and asynchronous property-based tests
